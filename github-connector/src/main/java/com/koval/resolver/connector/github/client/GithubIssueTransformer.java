...
//
//
//public class GithubIssueTransformer implements IssueTransformer<org.eclipse.egit.github.core.Issue> {
//
//  private static final Logger LOGGER = LoggerFactory.getLogger(GithubIssueTransformer.class);
...
//
//  public GithubIssueTransformer(GitHubClient restClient, String browseUrl) {
//    this.restClient = restClient;
//    this.browseUrl = browseUrl;
//  }
//
//  @Override
//  public Issue transform(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<Component> transformComponents(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<Version> transformFixVersions(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<Version> transformAffectedVersions(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<Comment> transformComments(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<IssueLink> transformIssueLinks(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<Attachment> transformAttachments(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<SubTask> transformSubTasks(org.eclipse.egit.github.core.Issue originalIssue) {
...
//  }
//
//  private List<IssueField> transformIssueFields(org.eclipse.egit.github.core.Issue originalIssue) {
...
//
//  @Override
//  public List<Issue> transform(Collection<org.eclipse.egit.github.core.Issue> originalIssues) {
//    List<Issue> transformedIssues = new ArrayList<>();
//    for (org.eclipse.egit.github.core.Issue originalIssue : originalIssues) {
